...
export default function Home() {
  ...
  return (
    <div>
      ...
      <Link href="https://sellercentral.amazon.co.jp/apps/authorize/consent?application_id=amzn1.sp.solution.4f4d0d53-3b9a-4158-88ec-c2118bafc164&state=stateexample&version=beta" legacyBehavior>
